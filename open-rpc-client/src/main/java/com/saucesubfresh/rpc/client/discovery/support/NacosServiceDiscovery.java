 ...
 */
@Slf4j
public class NacosServiceDiscovery extends AbstractServiceDiscovery implements InitializingBean, DisposableBean, EventListener {
    private static final String REMOVER = "DEFAULT_GROUP@@";
    private final NamingService namingService;
    private final NamespaceService namespaceService;

    public NacosServiceDiscovery(NamingService namingService, InstanceStore instanceStore, NamespaceService namespaceService) {
        super(instanceStore);
